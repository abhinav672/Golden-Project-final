...
function preload() {
  ...
  varanasiImage = loadImage("images/varanasi.gif")
...
function setup() {
  ...
  varanasi = createSprite(378, 378, 3, 30)
...
function draw() {
  ...
  if (gameState === "home") {
    ...
    fill("yellow");
    stroke("black");
    text("Welcome to Dreamy Travels!!", 200, 200)
  ...
  if (gameState === "conv1") {
    ...
    wall22.visible = false
    textSize(20)
    text("Hello God!!", 100, 210)
    text("Please guide me so that", 80, 230)
    text("I can obtain salvation", 90, 250)
    textSize(30)
  ...
  if (gameState === "conv3") {
    ...
    man.visible = true;
    textSize(20)
    text("Going to visit Varanasi", 100, 250)
    // mcloud.visible = true;
    // gcloud.visible = false;
    wall1.visible = false
    wall2.visible = false
  ...
  if (gameState === "level1.1") {
    ...
    image(varanasiImage, 378, 340, 100, 100)
